...
export const PlayCircle = ({ size = 24, color = 'currentColor', ...props }) => (
  <IconWrapper size={size} color={color} {...props}>
    ...
    <path d="M12.2415 23.0442C11.9056 23.2885 11.4344 23.0485 11.4344 22.6332V8.36683C11.4344 7.95149 11.9056 7.71154 12.2415 7.95584L22.0496 15.089C22.3287 15.292 22.3287 15.708 22.0496 15.911L12.2415 23.0442Z" fill="currentColor"/>
    </svg>
  </IconWrapper>
);
